...
public class Test_BidBook {
	...
	public void test_Sweep() {
		...
		Side side3 = Side.SELL;
		Quantity quantity3 = new Quantity( 1500 );
		Price price3 = new Price( 1260000 );
		...
		BidBook bb1 = new BidBook();
		bb1.add(p0);
		bb1.add(p1);
		bb1.add(p2);
		
		Comms comms = bb1.sweep(sweepingOrder3);
		
		assertEquals(2, comms.getFills().size());
		assertEquals(1200, comms.getRestingOrderConfirmations().getLast().getQuantity().get_Quantity());
